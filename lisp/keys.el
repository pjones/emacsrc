...
(define-key pjones:z-map      "3"    'elscreen-jump)
(define-key pjones:z-map      "4"    'elscreen-jump)
(define-key pjones:z-map      "5"    'elscreen-jump)
(define-key pjones:z-map      "6"    'elscreen-jump)
