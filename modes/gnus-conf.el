...
(defun pjones:gnus-group-mode-hook ()
  "Hook to set up `gnus-group-mode'."
...
(defun pjones:gnus-summary-mode-hook ()
  "Hook to set up `gnus-summary-mode'."
...
(defun pjones:gnus-article-mode-hook ()
  "Hook to set up `gnus-article-mode'."
...
;;; Hooks:
(add-hook 'gnus-article-mode-hook #'pjones:gnus-article-mode-hook)
