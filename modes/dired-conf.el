...
(let ((map dired-mode-map))
  ...
  (define-key map (kbd "M-1") (pjones:dired-cwd-do 'dired-do-shell-command))
  (define-key map (kbd "M-5") #'dired-do-query-replace-regexp)
  (define-key map (kbd "M-7") (pjones:dired-cwd-do 'dired-do-async-shell-command))
