...
(defun color-theme-pmade ()
  (let ((yellow     "#b58900")
    ...
    (custom-set-faces
     ...
     `(cursor         ((t (:background ,fg-normal :foreground ,bg-normal))))
     ...
     `(font-lock-comment-delimiter-face ((t (:foreground ,violet :bold t))))
     `(font-lock-comment-face           ((t (:foreground ,fg-low :italic t))))
