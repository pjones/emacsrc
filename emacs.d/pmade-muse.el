...
(setq muse-project-alist
      `(("www.contextualdevelopment.com"
         (,@(muse-project-alist-dirs pmade-com-src) :default "index" :set (muse-barecms-url "http://www.contextualdevelopment.com"))
        ...
        ("labs/sva"
         (,@(muse-project-alist-dirs pmade:sc-src-path) :default "index" :set (muse-barecms-url "http://www.contextualdevelopment.com" muse-barecms-base-path "/labs/sva/"))
